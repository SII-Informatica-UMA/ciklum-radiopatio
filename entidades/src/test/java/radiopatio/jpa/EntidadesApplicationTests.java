    ...
    public class BaseVacia {
        ...
        public class EjercicioVacio {
            ...
            public void devuelveEjerciciosVacios() {
                String url = String.format("http://localhost:8080/ejercicio?entrenador=1", port);
                ...
                try {
                    ...
                    System.out.println("Respuesta JSON: " + responseEntity.getBody());

                    assertThat(responseEntity.getStatusCode().value()).isEqualTo(200);

                    // Convertir el JSON a una lista de EjercicioDTO manualmente para comprobar
                    // errores
                    ObjectMapper objectMapper = new ObjectMapper();
                    List<EjercicioDTO> ejercicios = objectMapper.readValue(responseEntity.getBody(),
                            new TypeReference<List<EjercicioDTO>>() {
                            });

                    assertThat(ejercicios).isEmpty();
                } catch (Exception e) {
                    e.printStackTrace();
