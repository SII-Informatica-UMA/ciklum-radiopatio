...
public interface EjercicioRepository extends JpaRepository<Ejercicio,Long> {
    ...
    List<Ejercicio> findByTipoDificultadYMaterial(@Param("tipo") String tipo, @Param("dificultad") String dificultad, @Param("material") String material);
    //difiultad mayor o igual a una dada
    @Query("SELECT e FROM Ejercicio e WHERE e.dificultad >= :dificultad")
    List<Ejercicio> findByDificultadMayorOIgual(@Param("dificultad") String dificultad);
    //difiultad menor o igual a una dada
    @Query("SELECT e FROM Ejercicio e WHERE e.dificultad <= :dificultad")
    List<Ejercicio> findByDificultadMenorOIgual(@Param("dificultad") String dificultad);
    
    //para musculos trabajados
    @Query("SELECT e FROM Ejercicio e WHERE e.musculosTrabajados LIKE %:musculo%")
    List<Ejercicio> findByMusculosTrabajados(@Param("musculo") String musculo);
